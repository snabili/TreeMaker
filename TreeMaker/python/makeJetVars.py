...
def makeJetVarsAK8(self, process, JetTag, suff, storeProperties, SkipTag=cms.VInputTag(), systType="", doECFs=True, doDeepAK8=True, doDeepDoubleB=True, CandTag=cms.InputTag("packedPFCandidates"),puppiSpecific="", subjetTag='SoftDropPuppiUpdated', isAK15=False):
    ...
    if storeProperties==0:
	    ...
	    if isAK15:
		 ...
		 JetPropertiesAK8.ecfC2b1 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:cb1AK15PuppiSoftDropC2')
                 JetPropertiesAK8.ecfC2b2 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:cb2AK15PuppiSoftDropC2')
                 JetPropertiesAK8.ecfC3b1 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:cb1AK15PuppiSoftDropC3')
                 JetPropertiesAK8.ecfC3b2 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:cb2AK15PuppiSoftDropC3')
		 JetPropertiesAK8.ecfM2b1 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:mb1AK15PuppiSoftDropM2')
		 ...
		 JetPropertiesAK8.ecfD2b1 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:db1AK15PuppiSoftDropD2')
                 JetPropertiesAK8.ecfD2b2 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:db2AK15PuppiSoftDropD2')
                 #JetPropertiesAK8.ecfD3b1 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:db1AK15PuppiSoftDropD3')
                 #JetPropertiesAK8.ecfD3b2 = cms.vstring('ak15PFJetsPuppiSoftDropValueMap:db2AK15PuppiSoftDropD3')
			...
			'JetProperties'+suff+':ecfD2b1(Jets'+suff+'_ecfD2b1)',
                        'JetProperties'+suff+':ecfD2b2(Jets'+suff+'_ecfD2b2)',
                        #'JetProperties'+suff+':ecfD3b1(Jets'+suff+'_ecfD3b1)',
                        #'JetProperties'+suff+':ecfD3b2(Jets'+suff+'_ecfD3b2)',
	         ])
            else:
		 JetPropertiesAK8.properties.extend([
                     "ecfN2b1",
